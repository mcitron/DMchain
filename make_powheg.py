def make_powheg_input(com,nevents,DMmass,DMlambda,DMlambdawidth,spin):
 if (spin<0):
  return '''# minimum suggested values for ncall and itmx: 
# (ncall1,itmx1,ncall2,itmx2) = (250K,5,1M,5)

idDM 19   ! id of DM particles 
                ! (+- 19 is the default, but might not always work.
                ! Using the id of neutralinos is recommended)


vdecaymode  {0}   ! 1 for V-mediated fermionic DM
                ! 2 for A-mediated fermionic DM
                ! -1, -2 for full theory (mediator mass and width needed)

DMmass      {1}   ! DM-candidate mass
#DMLambda    {2} ! UV scale
...
bornktmin 80     ! (default 0d0) generation cut. Minimum kt in underlying Born
###
bornsuppfact 150 ! (default 0d0) mass param for Born suppression factor. If < 0 suppfact = 1
###
withnegweights 1  ! (default 0) if 1, use negative weights
smartsig 1

numevts {4}    ! number of events to be generated
ih1   1           ! hadron 1 (1 for protons, -1 for antiprotons)
ih2   1           ! hadron 2 (1 for protons, -1 for antiprotons)
ebeam1 {5}d0     ! energy of beam 1
ebeam2 {6}d0     ! energy of beam 2
...
#manyseeds 1       ! Used to perform multiple runs with different random
                   ...
                   ! The event file is called pwgevents-'j'.lhe'''.format(str(int(spin)),DMmass,DMlambda,DMlambdawidth,nevents,int(com/2.),int(com/2.))
 elif (spin>0):
  return '''# minimum suggested values for ncall and itmx: 
# (ncall1,itmx1,ncall2,itmx2) = (250K,5,1M,5)
